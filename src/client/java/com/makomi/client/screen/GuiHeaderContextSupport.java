	...
	private static boolean isCorePairingContextToken(String normalizedToken) {
		...
		return switch (normalizedToken) {
			case LinkGuiDisplayContext.CORE,
				...
				LinkGuiDisplayContext.WIRELESS_REDSTONE_BLOCK,
				LinkGuiDisplayContext.WIRELESS_REDSTONE_LAMP,
				LinkGuiDisplayContext.WIRELESS_SEA_LANTERN,
				LinkGuiDisplayContext.WIRELESS_OAK_DOOR,
				LinkGuiDisplayContext.WIRELESS_IRON_DOOR,
				LinkGuiDisplayContext.WIRELESS_OAK_TRAPDOOR,
				LinkGuiDisplayContext.WIRELESS_IRON_TRAPDOOR,
				LinkGuiDisplayContext.WIRELESS_OAK_FENCE_GATE,
				LinkGuiDisplayContext.WIRELESS_NOTE_BLOCK,
				LinkGuiDisplayContext.WIRELESS_TNT -> true;
			default -> false;
		};
	}
	...
	private static boolean isTriggerSourcePairingContextToken(String normalizedToken) {
		...
		return switch (normalizedToken) {
			case LinkGuiDisplayContext.TRIGGER_SOURCE,
				...
				LinkGuiDisplayContext.WIRELESS_OAK_BUTTON,
				LinkGuiDisplayContext.WIRELESS_SPRUCE_BUTTON,
				LinkGuiDisplayContext.WIRELESS_BIRCH_BUTTON,
				LinkGuiDisplayContext.WIRELESS_JUNGLE_BUTTON,
				LinkGuiDisplayContext.WIRELESS_ACACIA_BUTTON,
				LinkGuiDisplayContext.WIRELESS_CHERRY_BUTTON,
				LinkGuiDisplayContext.WIRELESS_DARK_OAK_BUTTON,
				LinkGuiDisplayContext.WIRELESS_MANGROVE_BUTTON,
				LinkGuiDisplayContext.WIRELESS_BAMBOO_BUTTON,
				LinkGuiDisplayContext.WIRELESS_CRIMSON_BUTTON,
				LinkGuiDisplayContext.WIRELESS_WARPED_BUTTON,
				LinkGuiDisplayContext.WIRELESS_POLISHED_BLACKSTONE_BUTTON,
				LinkGuiDisplayContext.WIRELESS_OAK_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_SPRUCE_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_BIRCH_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_JUNGLE_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_ACACIA_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_CHERRY_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_DARK_OAK_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_MANGROVE_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_BAMBOO_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_CRIMSON_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_WARPED_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_POLISHED_BLACKSTONE_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_LIGHT_WEIGHTED_PRESSURE_PLATE,
				LinkGuiDisplayContext.WIRELESS_HEAVY_WEIGHTED_PRESSURE_PLATE,
