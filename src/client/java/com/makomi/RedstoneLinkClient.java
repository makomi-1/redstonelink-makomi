...
public class RedstoneLinkClient implements ClientModInitializer {
	...
	private static void registerRenderLayers() {
		...
		BlockRenderLayerMap.putBlock(ModBlocks.HIDE_TOGGLE_EMITTER, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.LINK_PULSE_EMITTER, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.HIDE_PULSE_EMITTER, ChunkSectionLayer.TRANSLUCENT);
		...
		BlockRenderLayerMap.putBlock(ModBlocks.HIDE_SEND_FILTER, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.LINK_RECEIVE_FILTER, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.HIDE_RECEIVE_FILTER, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.LINK_CHUNK_ACTIVATOR, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.HIDE_CHUNK_ACTIVATOR, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.LINK_REPEATER, ChunkSectionLayer.TRANSLUCENT);
		BlockRenderLayerMap.putBlock(ModBlocks.HIDE_REPEATER, ChunkSectionLayer.TRANSLUCENT);
