...
public final class ModBlockEntities {
	...
	public static final BlockEntityType<HideCoreBlockEntity> HIDE_CORE = register(
		"hide_core",
		FabricBlockEntityTypeBuilder.create(HideCoreBlockEntity::new, ModBlocks.HIDE_CORE).build()
	);
	...
	public static final BlockEntityType<HideSyncTriggerSourceBlockEntity> HIDE_SYNC_TRIGGER_SOURCE = register(
		...
		FabricBlockEntityTypeBuilder.create(HideSyncTriggerSourceBlockEntity::new, ModBlocks.HIDE_SYNC_TRIGGER_SOURCE).build()
	);
