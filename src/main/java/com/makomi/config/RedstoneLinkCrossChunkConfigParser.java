...
final class RedstoneLinkCrossChunkConfigParser {
	...
	static RedstoneLinkCrossChunkConfig parse(Properties props) {
		...
		return new RedstoneLinkCrossChunkConfig(
			...
			RedstoneLinkConfigParseSupport.parseInt(props, "crosschunk.forceLoad.maxPerTick", 8, 1, 128),
			RedstoneLinkConfigParseSupport.parseInt(props, "crosschunk.forceLoad.maxPerSourcePerTick", 2, 1, 32),
