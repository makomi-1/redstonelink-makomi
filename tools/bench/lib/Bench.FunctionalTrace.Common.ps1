...
function Test-FunctionalCommandAssertHardFailure {
	...
	$hardFailurePatterns = @(
		...
		"(?i)\bplayer[- ]only\b",
		"(?i)\bAlias `.+` is invalid\b",
		"(?i)\bAlias `.+` is already occupied by\b",
		"(?i)\breason=(?:invalid characters|numeric only)\b",
		"(?i)\bwhitelist set input is empty\b",
		"(?i)\bToo many whitelist set serials\b",
		"\u6ca1\u6709\u8db3\u591f\u6743\u9650",
		"\u64cd\u4f5c\u8fc7\u4e8e\u9891\u7e41",
		"\u65e0\u6548\u5e8f\u53f7",
		"\u975e\u6cd5\u5b57\u7b26",
